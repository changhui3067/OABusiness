...
<div class="sidebar inner">
  ...
  <div class="sb_box">
    <h3 class="title">
      <div class="position">当前位置：<a href="index.html" title="网站首页">网站首页</a> &gt; <a href="/xuanchuanList">宣传报道列表</a></div>
      <span>宣传报道列表</span>
    </h3>
    <div class="clear"></div>
    ...
    <div class="active" id="newslist">
      <ul class='list-none metlist'>
        <li class='list top'><span>[2012-07-17]</span><a href='showXuanchuan.jsp/1' title=“新闻” target='_self'>请点击这里查看示例宣传报道</a><img class='listhot' src='resources/img/hot.gif' alt='图片关键词' /></li>
