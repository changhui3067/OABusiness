...
<div class="sidebar inner">
  ...
  <div class="sb_box">
    <h3 class="title">
      <div class="position">当前位置：<a href="index.html" title="网站首页">网站首页</a> &gt; <a href="#">示例新闻公告列表</a></div>
      <span>时事新闻列表</span>
    </h3>
    <div class="clear"></div>
    ...
    <div class="active" id="newslist">
      <ul class='list-none metlist'>
        <li class='list top'><span>[2012-07-17]</span><a href='#' title=“新闻” target='_self'>请点击这里查看示例新闻</a><img class='listhot' src='resources/img/hot.gif' alt='图片关键词' /></li>
