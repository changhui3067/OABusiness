...
<div class="sidebar inner">
  ...
  <div class="sb_box">
    <h3 class="title">
      <div class="position">当前位置：<a href="/" title="网站首页">网站首页</a> &gt; <a href="/newsList">新闻公告列表</a></div>
      <span>时事新闻列表</span>
    </h3>
    <div class="clear"></div>
    ...
    <div class="active" id="newslist">
      <ul class='list-none metlist'>
        <c:forEach items="${newsList}" var="news">
          <li class='list top'>
            <span>[<fmt:formatDate value='${news.pushtime}' pattern='yyyy-MM-dd'/>]</span>
            <a href='/shownews/${news.newsid}' target="_blank"> ${news.title}</a>
            <img class='listhot' src='resources/img/hot.gif' alt='图片关键词' />
          </li>
        </c:forEach>
